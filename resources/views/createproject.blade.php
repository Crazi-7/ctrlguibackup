...
<body>
    ...
    <div class="project-container">
        ...
        <form action="" method="post"> @csrf
            <label for="Username">Project name</label> <br>
            <div>
                <input class="@if ($errors->has('name')) input-error @endif" type="text" name="name" placeholder="Blank Title" min="5">
                @if ($errors->has('name'))
            ...
            <div class="button-wrapper">
                ...
                <input class="clickable button create-project" type="submit" value="Create" />
            </div>
